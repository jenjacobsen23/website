...
export function Navigation() {
  ...
  const handleSectionClick = (e: React.MouseEvent, sectionId: string) => {
    if (isHomePage) {
      // On homepage: prevent navigation and use smooth scroll
      e.preventDefault();
      scrollToSection(sectionId);
      setIsMenuOpen(false);
    } else {
      // On other pages: let the Link handle navigation to /#section
      setIsMenuOpen(false);
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 py-2 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link href="/" className="relative w-60 h-16 flex items-center justify-center overflow-hidden">
              <img
                src={logoSrc}
